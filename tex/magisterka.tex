...
\begin{figure}[!h]
    \centering
    \includegraphics[height=0.6\textheight]{images/FTDIarchitecture.png}
    \caption{Architektura Ekranu}
...
\begin{figure}[!h]
    \centering
    \includegraphics[height=0.3\textheight]{images/buf.png}
    \caption{Bufor dostępny podczas programowania ekranu FT800}
    \source{FT800 Programmers Guide}
\end{figure}
